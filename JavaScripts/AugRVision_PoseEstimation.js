var AugRVision_POS =  AugRVision_POS || {};

AugRVision_POS.Posit = function(modelSize, focalLength){
...
AugRVision_POS.Posit.prototype.buildModel = function(modelSize){
...
AugRVision_POS.Posit.prototype.init = function(){
  ...
  AugRVision_POS.pseudoInverse(vectors, np, this.objectMatrix);
};



 AugRVision_POS.Posit.prototype.pose = function(imagePoints){
  ...
  return error1.euclidean < error2.euclidean?
    new AugRVision_POS.Pose(error1.pixels, rotation1, translation1, error2.pixels, rotation2, translation2):
    new  AugRVision_POS.Pose(error2.pixels, rotation2, translation2, error1.pixels, rotation1, translation1);
};



AugRVision_POS.Posit.prototype.pos = function(imagePoints, rotation1, rotation2, translation){
...
AugRVision_POS.Posit.prototype.isValid = function(rotation, translation){
...
AugRVision_POS.Posit.prototype.iterate = function(imagePoints, posRotation, posTranslation, rotation, translation){
  var np = this.objectPoints.length,
...
AugRVision_POS.Posit.prototype.error = function(imagePoints, rotation, translation){
  var np = this.objectPoints.length,
...
AugRVision_POS.pseudoInverse = function(a, n, b){
  var w = [], v = [[],[],[]], s = [[],[],[]],
      wmax = 0.0, cn = 0,
      i, j, k;

  AugRVision_SVD.svdcmp(a, n, 3, w, v);
...
AugRVision_POS.Pose = function(error1, rotation1, translation1, error2, rotation2, translation2){
